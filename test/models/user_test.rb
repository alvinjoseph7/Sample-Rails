...
class UserTest < ActiveSupport::TestCase
  ...
  test "email validation should reject invalid addresses" do    
    invalid_addresses = %w[user@example,com user_at_foo.orguser.name@example. foo@bar_baz.com foo@bar+baz.com foo@bar..com]    
  ...
  test "password should have a minimum length" do
    @user.password = @user.password_confirmation= "alvin"
    assert_not @user.valid?
  end
end
